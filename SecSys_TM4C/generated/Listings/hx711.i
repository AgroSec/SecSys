#line 1 "modules\\LoadCell\\HX711.c"
...
#line 5 "modules\\LoadCell\\HX711.c"
 
#line 7 "modules\\LoadCell\\HX711.c"
...
#line 11 "modules\\LoadCell\\HX711.c"
...
#line 14 "modules\\LoadCell\\HX711.c"
...
uint32_t ReadCount(void){
	...
	GPIO_SetPin(PortE, 1<<3, 0);		
	Count=0;
	while(GPIOPinRead(0x40024000,0x00000004) == 0x00000004)	
	{;}
	...
	for (i=0;i<24;i++)
	{
			...
			Count=Count<<1;		
			GPIO_SetPin(PortE, 1<<3, 0);				
			if(GPIOPinRead(0x40024000,0x00000004) == 0x00000004) Count++;	
