#line 1 "drivers\\gpio_handler\\gpio_handler.c"
...
#line 8 "drivers\\gpio_handler\\gpio_handler.c"
...
#line 11 "drivers\\gpio_handler\\gpio_handler.c"
...
#line 12 "drivers\\gpio_handler\\gpio_handler.c"
...
#line 15 "drivers\\gpio_handler\\gpio_handler.c"
...
#line 16 "drivers\\gpio_handler\\gpio_handler.c"
...
#line 18 "drivers\\gpio_handler\\gpio_handler.c"
...
#line 21 "drivers\\gpio_handler\\gpio_handler.c"
...
uint8_t GPIO_InitPortOutput(ports_t port, uint8_t pin){
	switch (port) {
		case PortA:  
			...
			GPIOPinTypeGPIOOutput(0x40004000, pin);  
			GPIODirModeSet(0x40004000, pin, 0x00000001);  
			GPIOPadConfigSet(0x40004000, pin, 0x00000001,0x0000000C); 
			GPIOPinWrite(0x40004000, pin, 0);
			break;
		
		case PortB:  
			
			GPIOPinWrite(0x40005000, pin, 0);
			break;
		...
		case PortC:  
			...
			GPIOPinTypeGPIOOutput(0x40006000, pin);
			GPIODirModeSet(0x40006000, pin, 0x00000001);
			GPIOPadConfigSet(0x40006000, pin, 0x00000001,0x00000008);
			GPIOPinWrite(0x40006000, pin, 0);
			break;
		...
		case PortD:  
			...
			GPIOPinTypeGPIOOutput(0x40007000, pin);  
			GPIODirModeSet(0x40007000, pin, 0x00000001);  
			GPIOPadConfigSet(0x40007000, pin, 0x00000001,0x00000008);  
			GPIOPinWrite(0x40007000, pin, 0);
			break;
		...
		case PortE:  
			...
			GPIOPadConfigSet(0x40024000, pin, 0x00000001,0x00000008); 
			GPIOPinWrite(0x40024000, pin, 0);
			break;
		...
		case PortF:  
			...
			GPIOPinTypeGPIOOutput(0x40025000, pin);  
			GPIODirModeSet(0x40025000, pin, 0x00000001);  
			GPIOPadConfigSet(0x40025000, pin, 0x00000001,0x00000008); 
			GPIOPinWrite(0x40025000, pin, 0);
			break;		
...
uint8_t GPIO_SetPin(ports_t port, uint8_t pin, uint8_t status){
	switch (port) {
		...
		case PortA:  
			GPIOPinWrite(0x40004000, pin, status);
			break;
		case PortB:  
			GPIOPinWrite(0x40005000, pin, status);
			break;
		case PortC:  
			GPIOPinWrite(0x40006000, pin, status);
			break;
		case PortD:  
			GPIOPinWrite(0x40007000, pin, status);
			break;
		case PortE:  
			GPIOPinWrite(0x40024000, pin, status);
			break;
		case PortF:  
			GPIOPinWrite(0x40025000, pin, status);
			break;		
		default:
			return 0;  
	}
